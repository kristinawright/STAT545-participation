...
readable, colourful lol, labelled, quick visual correlation,
...
gapminder %>%
  plot_ly(x = ~gdpPercap,
          ...
          type = 'scatter',
          mode = 'markers') #or 'line'

#connect to online plotly to your online account to share
Sys.setenv("plotly_username"="FILL_THIS_IN") 
Sys.setenv("plotly_api_key"="FILL_THIS_IN")
