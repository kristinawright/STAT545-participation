...
Do you notice anything odd/wrong about the graph? alphabetical & dont want to drop "very low"
...
gapminder$continent %>%
  str()
#Asia is the top of the list in gapminder
```
...
- Filter `gapminder` dataset by 5 countries of your choice. How many levels are in your filtered dataset? still preserves levels even when you filter it

```{r}
gapminder$country %>%
  nlevels()

h_countries = c("Canada", "Japan", "Spain", "Philippines", "Greece")
gap <-gapminder %>%
...
order by count or reverse count
